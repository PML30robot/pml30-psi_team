...
\begin{document}
	...
	\begin{figure} [h]
			...
			\begin{minipage}{0.3\linewidth}
				\includegraphics[width=35mm,height=35mm]{7_1_robot}\\ Рисунок 8
			\end{minipage}
			\begin{minipage}{0.3\linewidth}
				\includegraphics[width=35mm,height=35mm]{7_2_robot}\\ Рисунок 9
			\end{minipage}
			\begin{minipage}{0.3\linewidth}
				\includegraphics[width=35mm,height=35mm]{7_3_robot}\\ Рисунок 10
			\end{minipage}		
	\end{figure}
	\end{enumerate}
\end{document}
